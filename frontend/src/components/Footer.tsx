          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
            {ratingPlatforms.map((platform, i) => (
              ...
              >
                ...
                {platform.isLogo ? (
                <div className="w-13 h-13 rounded-2xl bg-white border border-gray-200 shadow-sm flex items-center justify-center mb-4 group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                <Link href="/" aria-label="Arttag home" className="flex items-center justify-center w-full h-full ml-2">
                  <svg
